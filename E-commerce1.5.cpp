    ...
    do
    {
            ...
            switch(opcao)
            {
                case 'E':
                     ...
                     while(!feof(arq))
                     {
                         atributosProd = fgets(linha,MAX_LINHA,arq);
                         if (atributosProd)
                         {
                             ...
                             if(opcao == 'D' && (strcmp(leituraDescricao,produtoEletro.descricao) == 0))
                             {
                                 ...
                                 if(opcao == 'C' && (strcmp(leituraCor,produtoEletro.cor) == 0))
                                 {
                                     imprime_eletro(produtoEletro);
                                     codProdEncontrados[i] = produtoEletro.codigo;
                                     i++;
            ...
            do
            {
                textcolor(LIGHTGREEN);fflush(stdin);scanf("%c", &opcao);
                opcao=toupper(opcao);
                if(opcao=='S')
                {
                     maisUma=true;
...
{
    FILE *arq;
    char opcao, cadastroChar[MAX_DIGITOS];
