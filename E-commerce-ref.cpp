...
void pesquisar ()
{
    ...
    do
    {
            ...
            switch(opcao)
            {
                case 'E':
                     ...
                     if(arq == NULL)
                     {
                         ...
                         do
                         {
                             textcolor(LIGHTGREEN);fflush(stdin);scanf("%c",&opcao);opcao=toupper(opcao);
                             if((opcao=='D') || (opcao=='C') || (opcao=='P') || (opcao=='T') || (opcao=='G'))
                                 validaOpcao=true;
                             else
                             {
                                  textcolor(LIGHTRED);
                         ...
                         switch(opcao)
                         {
                             case 'D':
                                  printf("Informe a descricao buscada: ");
                                  textcolor(LIGHTGREEN);fflush(stdin);gets(objeto);
                                  strcpy(objeto,strlwr(objeto));
                                  break;
                             case 'T':
                                  ...
                                  do
                                  {
                                      ...
                                      if((strcmp(objeto,"PP")==0) || (strcmp(objeto,"P")==0) || (strcmp(objeto,"M")==0) || (strcmp(objeto,"G")==0) || (strcmp(objeto,"XG")==0))
                                          validaOpcao=true;
                                      else
                                      {
                                           textcolor(LIGHTRED);
                             ...
                             case 'C':
                                  printf("Informe a cor buscada: ");
                                  textcolor(LIGHTGREEN);fflush(stdin);scanf("%s",objeto);
                                  strcpy(objeto,strlwr(objeto));
                                  break;
                             case 'G':
                                  ...
                                  do
                                  {
                                      textcolor(LIGHTGREEN);fflush(stdin);gets(objeto);
                                      strupr(objeto);
                                      if((strcmp(objeto,"MASCULINO")==0) || (strcmp(objeto,"FEMININO")==0) || (strcmp(objeto,"UNISSEX")==0))
                                          validaOpcao=true;
                                      else
                                      {
                                           textcolor(LIGHTRED);
            ...
            do
            {
                textcolor(LIGHTGREEN);fflush(stdin);scanf("%c", &resposta);
                resposta=toupper(resposta);
                if(resposta=='S')
                {
                     maisUma=true;
...
void vizualizacompras(int cadastro)
{
     ...
     else
     {
             if(fread(&carrinho, sizeof(CARRINHO), 1, arq)==1)
             {
                 printf("\nVoce possui");textcolor(LIGHTGREEN);printf(" %d ", carrinho.itensEletro);textcolor(WHITE);
                 printf("eletrodomesticos e");textcolor(LIGHTGREEN);printf(" %d ", carrinho.itensVestuario);
             ...
             for(i=0; i<totalCarrinhosAbertos; i++)
             {
                           ...
                           while(!feof(arq))
                           {
                                ...
                                if(codigo==carrinhosAbertos[i])
                                {
                                     textcolor(WHITE);
                                     printf("\n===========================================");
                                     printf("\nCodigo: ");textcolor(LIGHTGREEN);printf("%d", codigo);
                                     textcolor(WHITE);
...
void verificaEstoque()
{
     ...
     while(!feof(arq))
     {
         ...
         textcolor(WHITE);printf("\n====================================================");
         printf("\nCodigo do produto: ");
         textcolor(LIGHTGREEN);printf("%s", strtok(string,","));
...
void clientesCadastrados()
{
      ...
      while(!feof(arq))
      {
          fgets(string, sizeof(string), arq);
          printf("\n===========================================");
          printf("\nCodigo: ");textcolor(LIGHTGREEN);printf("%s", strtok(string, ","));
          textcolor(WHITE);
          printf("\nNome: ");textcolor(LIGHTGREEN);printf("%s", strtok(NULL, ","));
          textcolor(WHITE);
          printf("\nTipo: ");textcolor(LIGHTGREEN);printf("%s", strtok(NULL, "\n"));
...
void menuGERENTE(char nome[], int cadastro)
{
    ...
    do
    {
        system("cls");
        textcolor(YELLOW);printf("\nGERENTE: ");
        textcolor(LIGHTGREEN);printf(" %s", nome);
        textcolor(WHITE);printf("\nData: %s Hora: %s",__DATE__,__TIME__);
        printf("\n====================================================================");
        printf("\nSelecione a letra correspondente em verde para acessar a opcao.\n");
